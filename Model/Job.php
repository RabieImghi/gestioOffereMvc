...
class Job {
    public static function JobCout(){
    ...
    public static function JobCoutActiveInactive($status){
        $conn = Connection::getConnection();
    ...
    public static function Jobapprove($status){
        $conn = Connection::getConnection();
    ...
    public static function GetJobs($isActive){
        $conn = Connection::getConnection();
        if($isActive==3){
    ...
    public static function AddJobs($title,$description,$entreprise,$location,$IsActive,$approve,$src){
    ...
    public static function UpdateJobs($title,$description,$entreprise,$location,$IsActive,$approve,$id_Jobs){
        $conn = Connection::getConnection();
    ...
    public static function DeletJob($idJob){
        $conn = Connection::getConnection();
